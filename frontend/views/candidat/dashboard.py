...
def show():
    ...
    for app in get_applications():
        with st.container(border=True):
            ...
            st.write(f"Statut : {app['statut']}")

    st.divider()
    st.subheader("🤖 Conseils IA")
    st.success("Ajoutez davantage de mots-clés techniques.")
    st.info("Complétez votre profil LinkedIn.")
    st.warning("Ajoutez un projet personnel récent.")
